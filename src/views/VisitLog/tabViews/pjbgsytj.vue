  ...
  <div class="tab-container">
    ...
    >
      ...
      <el-table-column prop="numberOfHits" label="点数" align="center">
        <template slot-scope="scope">{{ scope.row.numberOfHits || '/' }}</template>
      </el-table-column>
      ...
      <el-table-column prop="shareNumber" label="共享次数" align="center">
        <template slot-scope="scope">{{ scope.row.shareNumber || '/' }}</template>
      </el-table-column>
    </el-table>
    ...
    >
      ...
      <el-table-column prop="applyCompanyName" label="申请企业" align="center"> </el-table-column>
      <el-table-column prop="userName" label="申请人" align="center"> </el-table-column>
      <el-table-column prop="companyName" label="申请人所在公司" align="center"> </el-table-column>
      <el-table-column prop="applyTime" label="申请时间" align="center"> </el-table-column>
    </el-table>
    <el-dialog title="中诚信添加监控情况" :visible.sync="dialog.visible" width="1100px">
      <MonitorSituation :searchOptions="{ ...searchOptions, flag: '0' }"></MonitorSituation>
    </el-dialog>
  </div>
</template>
<script>
