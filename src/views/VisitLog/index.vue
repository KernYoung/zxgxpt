  ...
  <div class="container-wrapper">
    ...
    <div class="container">
      <div class="search-box">
        ...
        <el-select v-model="search.company" placeholder="公司名称" style="margin-right:10px">
          <el-options v-for="(item, index) in companyOptions" :key="index" :value="item" value="item"></el-options>
        </el-select>
...
import * as Utils from '@/utils/tool.js'
export default {
  components: {
    yhfwtj,
    xbbgsytj,
    ...
    getAllCompany() {
      ...
      this.$ajax.manage.getAllCompanyLevel(param).then((res) => {
        if (res.data.code == 0) {
          ...
          let arr = Utils.formatTreeData(res.data.treeData, 'code', 'scode', this.topValue, false)
          console.log(arr)
          // this.dataTree = arr;
        }
      })
