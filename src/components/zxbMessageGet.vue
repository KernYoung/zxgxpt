  ...
  <el-dialog title="信保消息"
    ...
    <div class="report-box">
      ...
      <table border="1" class="report-table">
        <tr>
          <td colspan="5" style="background:#E3E3E3;font-weight:bold">信保消息发送</td>
        </tr>
        <tr class="gbGray">
          <th width="80px">主业务编号</th>
          <th width="200px">子业务编号</th>
        ...
        <tr>
          ...
          <td>
            <el-input disabled v-model="noCreditCode.reportCorpEngName"></el-input>
          </td>
          <td>
            <el-input disabled v-model="noCreditCode.reportCorpaddress"></el-input>
          </td>
          <td>
            <el-input disabled v-model="noCreditCode.creditno"></el-input>
          </td>
          <td>
            <el-button type="primary" size="mini" @click="applyHaveCode">点击获取</el-button>
          </td>
        </tr>
      </table>
    </div>
    ...
    <div class="report-box">
      <table border="1" class="report-table">
        <tr>
          <td colspan="5" style="background:#E3E3E3;font-weight:bold">信保消息获取</td>
        </tr>
        <tr class="gbGray">
          <th width="80px">主业务编号</th>
          <th width="200px">子业务编号</th>
        ...
        <tr>
          ...
          <td>
            <el-button type="primary" size="mini" @click="applyNoCode">点击发送</el-button>
          </td>
        </tr>
      </table>
    </div>
